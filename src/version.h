...
#define CZ_VER_MINOR		1		/*!< Application minor version number. */
#define CZ_VER_STRING		"0.1"		/*!< Application version string. */

#define CZ_VER_STATE		"SVN"	 	/*!< Application release state. E.g.
