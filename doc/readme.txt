...
1. Microsoft Visual C++ 2005 (not 2008!). Having Express edition is enough.
   Unfortunatly you can't use it with MinGW32 or Cygwin because NVIDIA doesn't
...
2. Qt 4.4.0 (OpenSource) or close to it. You should build Qt with
   ...
   The best way to destribute CUDA-Z is to make it as much as posible DLLs
   independed. To reach this goal you should build Qt static.
   ...
   Additionaly it's good to make resulting binary file independed from
