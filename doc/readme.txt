...
2. Qt 4.8.0 (OpenSource) or later version. You should build Qt with
   Microsoft Visual C++ 2005/2008/2010 (Qt built with MinGW will not be linked with
   ...
   msvc?80.dll/msvc?90.dll/msvc?100.dll. To make this you should change some variables in
...
3. CUDA driver and CUDA toolkit installed on your computer.
   http://www.nvidia.com/object/cuda_get.html (v. 4.0+)
...
Qt development package or source code, NVIDIA driver and toolkit (v. 4.0+)
